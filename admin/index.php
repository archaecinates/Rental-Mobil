...
$query2 = mysqli_query($conn, "SELECT COUNT(id_user) as jumlah_petugas FROM tbl_user");
$jumlah_petugas = mysqli_fetch_assoc($query2);
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-stats ml-3 ml-sm-0">
                            <div class="numbers">
                                ...
                                <h4 class="card-title"><?= $jumlah_petugas['jumlah_petugas']; ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
